...
use PedestalNamespace\Internals\Facades\Strng;
...
abstract class PostType
{
    ...
    {
        $slug = (bool) $this->post_type_slug ? $this->post_type_slug : $this->get_post_type_name();
    ...
    {
        $name = (bool) $this->post_type_name ? $this->post_type_name : (new \ReflectionClass($this))->getShortName();
    ...
    {
        $current_labels = wp_parse_args($this->labels, [
